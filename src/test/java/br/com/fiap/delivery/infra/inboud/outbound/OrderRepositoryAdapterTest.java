package br.com.fiap.delivery.infra.inboud.outbound;
...
public class OrderRepositoryAdapterTest {
    ...
    void testCreateOrderSuccess() {
        ...
        OrderDomain order = new OrderDomain(orderId, customerName, creationAt, price, status, null);
        OrderEntity expectedEntity = new OrderEntity(orderId, customerName, creationAt, price, status, null);
    ...
    void testSearchBySuccess() {
        Long orderId = 1L;
        OrderEntity expectedEntity = new OrderEntity(orderId, "Test Customer", LocalDateTime.now(), BigDecimal.ZERO, OrderStatus.RECEIVED, null);
